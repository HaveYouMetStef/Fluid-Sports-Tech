...
struct ContactForm: View {
    ...
    @Environment(\.presentationMode) var form
    ...
    var body: some View {
        VStack {
            ...
            Text("For any feedback or questions, email us at fluidsportstech@gmail.com or fill out the contact form below")
                    .padding()
                    .accentColor(.white)
                    .padding(.top, -15)
                    .font(.system(size: 22))
